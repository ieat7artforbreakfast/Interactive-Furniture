...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        bindListener, getMaterialEditableTextures, replaceMaterialEditableTexture, getObjectName,
        initObjectPicking, isObjectAmongObjects, retrieveObjectNames, getObjectByName,
...
registerOnClick('wooddark1', false, false, [0,1,2], function() {
  replaceTexture('WoodTexture0', 'wood_basecolor_40.jpg', './wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('woodlight2', false, false, [0,1,2], function() {
  replaceTexture('WoodTexture0', 'wood_basecolor_40.jpg', './wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('Woodmedium0', false, false, [0,1,2], function() {
  replaceTexture('WoodTexture0', 'wood_basecolor_40.jpg', './wood_basecolor_3.jpg', function() {});
}, function() {});

registerOnClick('Sphere.black', false, false, [0,1,2], function() {
  assignMat('Metal_stand', 'metalblack');
}, function() {});
...
registerOnClick('Sphere.white', false, false, [0,1,2], function() {
  assignMat('Metal_stand', 'metalwhite.002');
}, function() {});

registerOnClick('Sphere.grey', false, false, [0,1,2], function() {
  assignMat('Metal_stand', 'metalgrey');
}, function() {});

registerOnClick('Table top.white', false, false, [0,1,2], function() {
  assignMat('Table top', 'tabletopwhite');
}, function() {});

registerOnClick('Table top.black', false, false, [0,1,2], function() {
  assignMat('Table top', 'tabletopblack');
}, function() {});

registerOnClick('Table top.grey', false, false, [0,1,2], function() {
  assignMat('Table top', 'tabletopgrey');
}, function() {});
